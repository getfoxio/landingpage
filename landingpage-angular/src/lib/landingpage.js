"use strict";var r={landingpage:{__params__:{key:"",username:"",apiEndpoint:"https://localhost:9080/graphql/",build:!1,appUrl:"https://localhost:8080"},init:e=>new Promise((n,a)=>{r.landingpage.__params__.key=e.key,r.landingpage.__params__.username="",e.username&&(r.landingpage.__params__.username=e.username),e.apiUrl&&(r.landingpage.__params__.apiEndpoint=e.apiUrl),!!e.build&&e.build&&console.warn("HTML template builder is unavailable in this version. Use version with HTML builder."),r.landingpage.getUser().then(t=>{t&&n(t)}).catch(t=>{a(t)})}),openLink:(e,n)=>{window.open(e,n!==3?"_blank":"_self")},getUser:(e=r.landingpage.__params__.username,n=r.landingpage.__params__.key)=>{let a=`{
