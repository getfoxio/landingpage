...
const _hoisted_4 = {
  ...
  style: /*#__PURE__*/vue.normalizeStyle([{ 'pointer-events': 'none' }])
};
...
const _hoisted_29 = /*#__PURE__*/vue.createElementVNode("svg", {
  x: "0px",
  y: "0px",
  width: "24px",
  height: "24px",
...
const _hoisted_38 = /*#__PURE__*/vue.createElementVNode("a", {
  href: "https://getfox.io",
  class: "footer-link-getfox",
  target: ""
}, " Getfox ", -1 /* HOISTED */);
const _hoisted_39 = /*#__PURE__*/vue.createElementVNode("br", null, null, -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    (!_ctx.user)
      ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, "loading.."))
                ...
                (_ctx.user.profileImage)
                  ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [
                      vue.createElementVNode("div", _hoisted_4, [
                        vue.createElementVNode("form", _hoisted_5, [
                          ...
                          style: vue.normalizeStyle([
                {
                  color: _ctx.user.landingPage.textColor
                    ...
                    : 'none',
                        ...
                        }, vue.toDisplayString(_ctx.user.landingPage.title
    ...
    : 'none',
            ...
            color: _ctx.user.landingPage.textDescriptionColor
              ...
              : 'none',
                    ...
                    }, vue.toDisplayString(_ctx.user.landingPage.description), 5 /* TEXT, STYLE */)
                  ]))
                : vue.createCommentVNode("v-if", true)
            ], 6 /* CLASS, STYLE */),
            vue.createElementVNode("div", _hoisted_17, [
              vue.createElementVNode("ul", _hoisted_18, [
                (!_ctx.user.links.length)
                  ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_19, vue.toDisplayString(_ctx.user.translations.noLinksFound), 1 /* TEXT */))
                  : vue.createCommentVNode("v-if", true),
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.user.links, (link) => {
              ...
              'background-image':
                'url(' + _ctx.user.appUrl + '/' + $options.getLinkImageSource(link) + ')',
                    ...
                    vue.createElementVNode("div", _hoisted_21, [
                      vue.createElementVNode("div", _hoisted_22, vue.toDisplayString(link.name), 1 /* TEXT */),
                      (!!link.product)
                        ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_23, [
                            vue.createElementVNode("div", _hoisted_24, [
                              vue.createElementVNode("span", _hoisted_25, vue.toDisplayString(link.product.priceLabel === 'onlynow'
                          ...
                          : link.product.priceLabel == 'sale'
                            ...
                            : link.product.priceLabel === 'special'
                              ...
                              : ''), 1 /* TEXT */),
                              vue.createElementVNode("span", _hoisted_26, vue.toDisplayString(link.product.price) + " " + vue.toDisplayString(link.product.currency), 1 /* TEXT */),
                              vue.createElementVNode("span", _hoisted_27, vue.toDisplayString(_ctx.user.translations.buyNow), 1 /* TEXT */)
                            ])
                          ]))
                        : vue.createCommentVNode("v-if", true)
                    ]),
            ...
            vue.createElementVNode("div", _hoisted_31, [
              vue.createElementVNode("div", _hoisted_32, [
                vue.createElementVNode("a", {
                  ...
                  target: "_blank"
                }, vue.toDisplayString(_ctx.user.translations.support), 9 /* TEXT, PROPS */, _hoisted_33),
                vue.createElementVNode("a", {
                  class: "footer-link",
                  href: _ctx.user.appUrl + '/static/privacy',
                  target: "_blank"
                }, vue.toDisplayString(_ctx.user.translations.privacyPolicy), 9 /* TEXT, PROPS */, _hoisted_34)
              ]),
              vue.createElementVNode("div", _hoisted_35, [
                vue.createElementVNode("div", _hoisted_36, [
                  vue.createElementVNode("p", _hoisted_37, [
                    vue.createTextVNode(" ©" + vue.toDisplayString(_ctx.year) + ".  ", 1 /* TEXT */),
                    _hoisted_38,
                    vue.createTextVNode(" " + vue.toDisplayString(_ctx.user.translations.rights) + ".", 1 /* TEXT */),
                    _hoisted_39
                  ]),
                  vue.createElementVNode("p", _hoisted_40, [
                    vue.createTextVNode(vue.toDisplayString(_ctx.user.translations.madeWith) + "❤️" + vue.toDisplayString(_ctx.user.translations.forAll) + vue.toDisplayString(' ') + " ", 1 /* TEXT */),
                    vue.createElementVNode("a", _hoisted_41, vue.toDisplayString(' ') + vue.toDisplayString(_ctx.user.translations.foxes), 1 /* TEXT */)
                  ])
                ])
              ])
            ])
...
module.exports = getfox_landingpage;
