"use strict";var o=Object.defineProperty;var s=Object.getOwnPropertyDescriptor;var l=Object.getOwnPropertyNames;var p=Object.prototype.hasOwnProperty;var c=(e,a)=>{for(var n in a)o(e,n,{get:a[n],enumerable:!0})},d=(e,a,n,t)=>{if(a&&typeof a=="object"||typeof a=="function")for(let i of l(a))!p.call(e,i)&&i!==n&&o(e,i,{get:()=>a[i],enumerable:!(t=s(a,i))||t.enumerable});return e};var g=e=>d(o({},"__esModule",{value:!0}),e);var m={};c(m,{default:()=>u});module.exports=g(m);var r={landingpage:{__params__:{key:"",username:"",apiEndpoint:"https://api.getfox.io/graphql",build:!1,appUrl:"https://getfox.io"},init:e=>new Promise((a,n)=>{r.landingpage.__params__.key=e.key,r.landingpage.__params__.username="",e.username&&(r.landingpage.__params__.username=e.username),e.apiUrl&&(r.landingpage.__params__.apiEndpoint=e.apiUrl),!!e.build&&e.build&&console.warn("HTML template builder is unavailable in this version. Use version with HTML builder."),r.landingpage.getUser().then(t=>{t&&a(t)}).catch(t=>{n(t)})}),openLink:(e,a)=>{window.open(e,a!==3?"_blank":"_self")},getUser:(e=r.landingpage.__params__.username,a=r.landingpage.__params__.key)=>{let n=`{
