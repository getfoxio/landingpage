"use strict";var i={landingpage:{__params__:{key:"",username:"",apiEndpoint:"https://api.getfox.io/graphql",build:!1,appUrl:"getfox.io"},init:a=>new Promise((l,o)=>{i.landingpage.__params__.key=a.key,i.landingpage.__params__.username="",a.username&&(i.landingpage.__params__.username=a.username),a.apiUrl&&(i.landingpage.__params__.apiEndpoint=a.apiUrl);let e=!1;a.build&&(e=a.build),i.landingpage.getUser().then(n=>{n&&(e&&(i.landingpage.build(n),console.log("getfox.landingpage.build()")),l(n))}).catch(n=>{o(n)})}),openLink:(a,l)=>{window.open(a,l!==3?"_blank":"_self")},getUser:(a=i.landingpage.__params__.username,l=i.landingpage.__params__.key)=>{let o=`{
